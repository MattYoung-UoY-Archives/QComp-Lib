...
public class Chapter2BasisAndDimTests {
	...
	public static void main(String[] args) {
		...
		System.out.println(Complex.isUnitary(hermTest1) + "\n\n");
		
		ComplexNum[][] tensProdArr1 = {{new ComplexNum(3, 2), new ComplexNum(5, -1), new ComplexNum(0, 2)},
									{new ComplexNum(0, 0), new ComplexNum(12, 0), new ComplexNum(6, -3)},
									{new ComplexNum(2, 0), new ComplexNum(4, 4), new ComplexNum(9, 3)}};
		CompMat tensProd1 = new CompMat(tensProdArr1);
		
		ComplexNum[][] tensProdArr2 = {{new ComplexNum(1, 0), new ComplexNum(3, 4), new ComplexNum(5, -7)},
									{new ComplexNum(10, 2), new ComplexNum(6, 0), new ComplexNum(2, 5)},
									{new ComplexNum(0, 0), new ComplexNum(1, 0), new ComplexNum(2, 9)}};
		CompMat tensProd2 = new CompMat(tensProdArr2);
		
		System.out.println(Complex.tensorProd(tensProd1, tensProd2));
